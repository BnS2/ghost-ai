  ...
  if (dialogType === "create") {
    return (
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <CreateDialogContent onClose={onClose} onCreate={onCreate} isLoading={isLoading} />
      </Dialog>
    );
  }
  ...
  return (
    <DialogContent className="sm:max-w-[425px]">
      <DialogHeader>
        ...
        <DialogDescription>
          Current project: <span className="font-medium text-text-primary">{project.name}</span>
        </DialogDescription>
      </DialogHeader>
