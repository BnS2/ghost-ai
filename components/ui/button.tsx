...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-accent-primary focus-visible:ring-3 focus-visible:ring-accent-primary/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive/50 aria-invalid:ring-3 aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-accent-primary text-text-primary hover:bg-accent-primary/80",
        outline:
          "border-border-subtle bg-elevated/30 hover:bg-elevated/50 text-text-primary aria-expanded:bg-elevated/50",
        secondary: "bg-subtle text-text-primary hover:bg-subtle/80 aria-expanded:bg-subtle",
        ghost: "hover:bg-subtle/50 hover:text-text-primary aria-expanded:bg-subtle/50",
        destructive:
